...
import { OpportunitiesResponse, OpportunitiesState, opportunities } from './Opportunities.types'
...
export const setOpportunities = createAction<opportunities>(`${name} setOpportunities`)
export const getOpportunitiesSuccess = createAction<opportunities[]>(`${name} getOpportunitiesSuccess`)
export const normaliseOpportunitiesSuccess = createAction<opportunities>(`${name} normaliseOpportunitiesSuccess`)

import { F, addIndex, assoc, chain, complement, curry, ifElse, isNil, keys, map, reduce, zipObj } from 'ramda'
...
export const safeWhen = curry((cond: (...args: any[]) => any, callback: (...args: any[]) => any, data: any) =>
  ifElse(cond, callback, F)(data),
)
